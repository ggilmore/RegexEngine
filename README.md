...
Example of a graph generated from `toDOTFileFormat`'s output from the regex `((ab|b?)*w)`, before any character was consumed. The valid states are highlighted in red: ![example](http://i.imgur.com/EmgOj1i.png)
